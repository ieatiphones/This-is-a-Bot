...
exports.effect = function (args) {
    var mode = args[1][0].toUpperCase() + args[1].slice(1);
    image.noise(parseInt(args[0]), mode);
}

exports.info = {
    name: 'noise',
    usage: 'noise [radius] [type (Uniform, Gaussian, Multiplicative, Impulse, Laplacian, Poisson)]'
};